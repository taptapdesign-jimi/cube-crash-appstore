# Stack to Six adaptive music prototype

These are audition candidates derived from the preserved source theme.

- Source: `assets/sound/soundtrack/TapTapDesign-Stacktosixtheme.wav`
- Source format: 48 kHz 16-bit stereo PCM lossless WAV master
