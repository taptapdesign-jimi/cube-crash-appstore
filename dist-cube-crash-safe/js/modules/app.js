...
const MYSTERY_CANDIDATES = [
  ...
  './media/mystery-box.png',
  './media/mistery-box.png',
  './media/mystery-box.jpeg',
  './media/mistery-box.jpeg'
].filter(Boolean);

const COIN_CANDIDATES = [
  CONSTS.ASSET_COIN,
  './media/gold-coin.png',
  './media/gold-coin.jpeg'
].filter(Boolean);
...
export async function boot(){
  ...
  // viewport + fonts
  {
    ...
    style.textContent = `
      ...
      @font-face{ font-family:"LTCrow"; src:url("./media/fonts/LTCrow-Regular.ttf") format("truetype"); font-weight:400; font-style:normal; font-display:swap; }
      @font-face{ font-family:"LTCrow"; src:url("./media/fonts/LTCrow-Medium.ttf") format("truetype"); font-weight:500; font-style:normal; font-display:swap; }
      @font-face{ font-family:"LTCrow"; src:url("./media/fonts/LTCrow-SemiBold.ttf") format("truetype"); font-weight:600; font-style:normal; font-display:swap; }
      @font-face{ font-family:"LTCrow"; src:url("./media/fonts/LTCrow-Bold.ttf") format("truetype"); font-weight:700; font-style:normal; font-display:swap; }
      @font-face{ font-family:"LTCrow"; src:url("./media/fonts/LTCrow-ExtraBold.ttf") format("truetype"); font-weight:800; font-style:normal; font-display:swap; }
    `;
