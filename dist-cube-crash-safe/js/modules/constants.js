...
export const ASSET_TILE        = './media/tile.png';
export const ASSET_NUMBERS     = './media/tile_numbers.png';
export const ASSET_NUMBERS2    = './media/tile_numbers2.png';
export const ASSET_NUMBERS3    = './media/tile_numbers3.png';
export const ASSET_WILD        = './media/wild.png';
export const ASSET_MYSTERY     = './media/mystery-box.png';
export const ASSET_COIN        = './media/gold-coin.png';
export const SFX_EXPLODE       = './media/explode.mp3';
