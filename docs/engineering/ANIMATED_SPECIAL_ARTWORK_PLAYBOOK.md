...
- the first live copy of a direct-SVG family uses SVG; every additional Wild
  Star, Fish, and Flower also uses SVG, while later copies in the other
  families keep one lifetime-stable 50/50 choice between the original Pixi PNG
  and SVG;
