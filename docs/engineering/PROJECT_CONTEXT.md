...
- Forest Journey special progression: `journey-forest-wild-progression.ts` owns the cumulative player-facing pool (01 Star; 02 Mushroom; 03 Flower; 04 Honey; 06 Bee; 07 TNT), including the guaranteed first introduction drop. Bee reuses Wild Star gameplay without orbiting stars and owns a four-frame drag-safe idle plus its dedicated bush/leaf flight finale. `special-dice-registry.ts` continues to own visual-to-gameplay archetype mapping; generic Juice and Magnet do not enter the Forest pool.
