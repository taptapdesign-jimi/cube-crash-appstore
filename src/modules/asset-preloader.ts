...
const ALL_ASSETS: string[] = [
  ...
  './assets/star-hud.png',
  './assets/star-hud@2x.png',
  './assets/star-hud@3x.png',
  './assets/coin-hud.png',
  './assets/coin-hud@2x.png',
  './assets/coin-hud@3x.png',
  './assets/combo-hud.png',
  './assets/combo-hud@2x.png',
  './assets/combo-hud@3x.png',
  './assets/extra-combo-hud.png',
  './assets/extra-combo-hud@2x.png',
  './assets/extra-combo-hud@3x.png',
  './assets/mega-combo-hud.png',
  './assets/mega-combo-hud@2x.png',
  './assets/mega-combo-hud@3x.png',
