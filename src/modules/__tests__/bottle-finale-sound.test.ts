...
describe('Bottle finale sound', () => {
  ...
  test('exposes the same reduced Special foundation used by Bottle at merge commit', () => {
    ...
    expect(BOTTLE_MERGE6_PRIMARY_VOLUME).toBeCloseTo(
    ...
    expect(BOTTLE_MERGE6_CRASH_VOLUME).toBeCloseTo(
    ...
    expect(BOTTLE_MERGE6_BOOM_VOLUME).toBeCloseTo(
    ...
    expect(BOTTLE_MERGE6_STACK_VOLUME).toBeCloseTo(
