...
// Bottle uses the shared reduced Special foundation at the committed merge.
// The ocean-finale layers below only sweeten that independently owned base.
...
export const BOTTLE_MERGE6_PRIMARY_BASE_VOLUME =
  REGULAR_MERGE6_SOUND_BASE_VOLUME * SPECIAL_MERGE6_FOUNDATION_VOLUME_SCALE;
export const BOTTLE_MERGE6_PRIMARY_VOLUME =
...
export const BOTTLE_MERGE6_CRASH_BASE_VOLUME =
  REGULAR_MERGE6_CRASH_BASE_VOLUME * SPECIAL_MERGE6_FOUNDATION_VOLUME_SCALE;
export const BOTTLE_MERGE6_CRASH_VOLUME =
...
export const BOTTLE_MERGE6_BOOM_BASE_VOLUME =
  REGULAR_MERGE6_BOOM_BASE_VOLUME * SPECIAL_MERGE6_FOUNDATION_VOLUME_SCALE;
export const BOTTLE_MERGE6_BOOM_VOLUME =
...
export const BOTTLE_MERGE6_STACK_BASE_VOLUME =
  REGULAR_MERGE6_STACK_BASE_VOLUME * SPECIAL_MERGE6_FOUNDATION_VOLUME_SCALE;
export const BOTTLE_MERGE6_STACK_VOLUME =
