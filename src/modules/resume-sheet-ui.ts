...
export function addBottomSheetStyles(): void {
  ...
  style.textContent = `
    /* Button styles removed - using global .primary-button and .secondary-button classes instead */
    ...
    .resume-bottom-sheet {
      ...
      left: 0 !important;
      right: 0 !important;
      background-color: #F5F0EB !important; /* Fallback color matching paper texture */
      background-image: url('../../assets/modals/paper.png') !important;
