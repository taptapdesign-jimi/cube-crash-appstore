...
function buildFinaleRuntimes(options: FinalMergeHandoffOptions): FinaleRuntime[] {
  ...
  // Bee and the slowed Fishy Bubbles finale outlive the basic sparkle burst.
  // The real completion signal normally resolves first; this is only fallback
  // headroom so Clean Board cannot truncate either authored visual.
  const sparkleMaxWaitMs = 5000;
