...
export const BOARD_TRANSITION_FOREST_AMBIENT_BOOST = 1.2;
export const BOARD_TRANSITION_FOREST_AMBIENT_SOUND_VOLUME = Math.min(
  1,
  applySoundEffectsMasterGain(1) * BOARD_TRANSITION_FOREST_AMBIENT_BOOST,
);
export const BOARD_TRANSITION_FOREST_BEES_SMALL_ACTION_VOLUME = 0.2;
export const BOARD_TRANSITION_FOREST_BEES_SMALL_SOUND_VOLUME = Math.min(
  1,
  applySoundEffectsMasterGain(BOARD_TRANSITION_FOREST_BEES_SMALL_ACTION_VOLUME)
