...
import {
  JOURNEY_CARD_FLIP_BACK_ASSET,
  JOURNEY_CARD_FLIP_BACK_ASSET_2X,
...
export const JOURNEY_CARD_RETURN_REMINDER_LANDING_REBOUND_PROGRESS =
  JOURNEY_CARD_RETURN_REMINDER_LANDING_REBOUND_END_SECONDS
  / JOURNEY_CARD_RETURN_REMINDER_LANDING_TOTAL_SECONDS;
export const JOURNEY_CARD_RETURN_REMINDER_BACK_ASSET = JOURNEY_CARD_FLIP_BACK_ASSET;
export const JOURNEY_CARD_RETURN_REMINDER_BACK_ASSET_2X = JOURNEY_CARD_FLIP_BACK_ASSET_2X;
